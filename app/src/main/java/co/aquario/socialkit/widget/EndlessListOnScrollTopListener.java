...
public abstract class EndlessListOnScrollTopListener implements AbsListView.OnScrollListener {
    ...
    public EndlessListOnScrollTopListener() {
    }

    public EndlessListOnScrollTopListener(int visibleThreshold) {
        this.visibleThreshold = visibleThreshold;
    }

    public EndlessListOnScrollTopListener(int visibleThreshold, int startPage) {
        this.visibleThreshold = visibleThreshold;
