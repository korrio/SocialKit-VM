...
//	 */
//	private final Handler mVlcEventHandler = toolbar VideoPlayerEventHandler(this);
//
//
...
//		EventHandler em = EventHandler.getInstance();
//		em.callback(EventHandler.HardwareAccelerationError, toolbar Bundle());
//	}
//
...
//
//
//		ThreadUtils.runOnUiThread(toolbar Runnable() {
//            @Override
//            public void run() {
//                changeSurfaceSize(false);
//
...
//	 */
//	private final SurfaceHolder.Callback mSurfaceCallback = toolbar SurfaceHolder.Callback() {
//		@Override
