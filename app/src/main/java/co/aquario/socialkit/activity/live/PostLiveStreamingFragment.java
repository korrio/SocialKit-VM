...
public class PostLiveStreamingFragment extends BaseFragment {
    // audio device.
    ...
    private final static int VWIDTH = 853;
    ...
    public PostLiveStreamingFragment() {
        camera = null;
        vencoder = null;
        muxer = null;
    }

    public static PostLiveStreamingFragment newInstance() {
        
        Bundle args = new Bundle();
        
        PostLiveStreamingFragment fragment = new PostLiveStreamingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // initialize url.
        final EditText efu = (EditText) rootView.findViewById(R.id.flv_url);
        efu.setText(flv_url);
        ...
        final EditText evb = (EditText) rootView.findViewById(R.id.vbitrate);
        ...
        final Button btnPublish = (Button) rootView.findViewById(R.id.capture);
        final Button btnStop = (Button) rootView.findViewById(R.id.stop);
        final SurfaceView preview = (SurfaceView) rootView.findViewById(R.id.camera_preview);
    ...
    private void publish(Object onYuvFrame, SurfaceHolder holder) {
        ...
        parameters.setPictureSize(VWIDTH,VHEIGHT);
        ...
        parameters.setPreviewSize(VHEIGHT,VWIDTH);
    ...
    public void onResume() {
        ...
        final Button btn = (Button) rootView.findViewById(R.id.capture);
        btn.setEnabled(true);
    }
