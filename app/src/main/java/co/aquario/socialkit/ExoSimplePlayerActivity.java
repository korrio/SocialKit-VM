 ...
 */
public class ExoSimplePlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
    DemoPlayer.Listener,
  ...
  public static Intent startActivity(Activity activity, String streamUrl) {
    Intent i = new Intent(activity, ExoSimplePlayerActivity.class);
    i.putExtra("PATH", streamUrl);
