...
public class AdapterLivieHistory extends RecyclerView.Adapter<AdapterLivieHistory.ViewHolder> {
    ...
    public AdapterLivieHistory(Context context, ArrayList<Live> list) {
