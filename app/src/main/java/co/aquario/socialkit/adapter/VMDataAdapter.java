...
import co.aquario.socialkit.model.PhotoStory;
import co.aquario.socialkit.model.VMFeed;

public class VMDataAdapter implements SectionedAdapter {

    public static final String TAG = "VMDataAdapter";
    ...
    public VMDataAdapter(Context context) {
    ...
    public void update(VMFeed feed) {
