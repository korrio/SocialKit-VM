    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnFb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ParseFacebookUtils.logInWithReadPermissionsInBackground(FbLoginActivity.this, mPermissions, new LogInCallback() {
                    @Override
        ...
        parseFile.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                parseUser.saveInBackground(new SaveCallback() {
                    @Override
                    public void done(ParseException e) {
                        Toast.makeText(FbLoginActivity.this, "New user:" + name + " Signed up", Toast.LENGTH_SHORT).show();
                    }
                });
...
//Fetch profile photo
        ...
        Toast.makeText(FbLoginActivity.this, "Welcome back " + mUsername.getText().toString(), Toast.LENGTH_SHORT).show();
