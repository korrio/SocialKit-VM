...
public class LandingActivity extends AppCompatActivity {
    ...
    @InjectView(R.id.join_group_button)
    Button joinGroupButton;

    @OnClick(R.id.join_button)
    void onOneToOneClick() {
        if(!userIdTv.getText().toString().equals("") && !partnerIdTv.getText().toString().equals("")) {
            ChatActivity.startChatActivity(mActivity,Integer.parseInt(userIdTv.getText().toString()),Integer.parseInt(partnerIdTv.getText().toString()),0);
        }
    }

    @OnClick(R.id.join_group_button)
    void onLiveGroupClick() {
        if(!partnerIdTv.getText().toString().equals("")) {
            ChatActivity.startChatActivity(mActivity,Integer.parseInt(userIdTv.getText().toString()),Integer.parseInt(partnerIdTv.getText().toString()),1);
        }
    }
